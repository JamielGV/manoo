...
Manoo es un plugin para Claude Code que da a Claude control del mouse, teclado y capacidad de tomar capturas de pantalla en el equipo donde se instala, para ejecutar acciones que el usuario le pida directamente sobre la interfaz gráfica.
...
- No usar Manoo para actividades ilegales, fraude, acceso no autorizado a sistemas de terceros, o evasión de medidas de seguridad.
- No usar Manoo para automatizar interacciones que violen los términos de servicio de terceros (por ejemplo, bots en plataformas que lo prohíben).
- Ser responsable de las acciones que Manoo ejecute en su equipo — Manoo actúa según las instrucciones que el usuario o Claude, a petición del usuario, le indiquen.
...
Estos términos se rigen por las leyes de los Estados Unidos Mexicanos. Cualquier controversia se someterá a los tribunales competentes del Estado de México.

## 9. Contacto

Dudas, soporte o solicitudes de licencia: jamiel.garcia.velazquez@gmail.com
